...
Monitor desktop
================================================================
If you do not have a spare monitor, please skip to next section :ref:`Remote desktop & VNC <Remote>`. If you have a spare monitor, please follow the steps in this section. 
...
**If you have logged in Raspberry Pi via display, you can skip to** :ref:`VNC Viewer & VNC <VNC_Viewer>`.
...
The password is :combo:`blue font-bolder:raspberry` by default, case sensitive. You may need to type **yes** during the process.
...
Then you can skip to :ref:`VNC Viewer & VNC <VNC_Viewer>`.
...
Then 192.168.1.95 is my Raspberry Pi IP.
...
The shield is connected to the Raspberry Pi through the IO Port on the board. The positioning holes on the board are suitable for the Raspberry Pi. The features and functions are as follows.
...
- **Robot Shield board:** It requires two 18650 3.7v batteries. 
